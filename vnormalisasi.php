                ...
                <div class="card-style mb-30">
                  ...
                  <div class="table-wrapper table-responsive">
                    <table class="table">
                      ...
                      <?php
                      include 'koneksi.php';
                      $query = mysqli_query($db, "SELECT * FROM vnormalisasi order by id_nilai");
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="min-width">
                            <span class="status-btn warning-btn"><?php echo $data['normalisasi']?>  </span>
                          </td> 
                        </tr>
                        <?php } ?>
                        <!-- end table row -->
